...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.viponly = QtWidgets.QPushButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.viponly.sizePolicy().hasHeightForWidth())
        self.viponly.setSizePolicy(sizePolicy)
        self.viponly.setFlat(False)
        self.viponly.setObjectName("viponly")
        self.horizontalLayout_6.addWidget(self.viponly)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.viponly.setText(_translate("Dialog", "VIP"))
