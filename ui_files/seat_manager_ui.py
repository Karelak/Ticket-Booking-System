...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.widget.setGeometry(QtCore.QRect(30, 10, 980, 720))
        ...
        self.tablewithallseats = QtWidgets.QTableWidget(self.widget)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Show name here maybe showid too"))
